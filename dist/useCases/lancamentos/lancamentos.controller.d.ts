...
export declare class LancamentosController {
    ...
    create(createLancamentoDto: CreateLancamentoDto): Promise<CreateLancamentoDto & import("./entities/lancamentos.entity").Lancamentos>;
    findAll(): Promise<import("./entities/lancamentos.entity").Lancamentos[]>;
